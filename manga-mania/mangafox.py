...
This Python3 script scrapes http://mangafox.me
to help you read manga from your desktop.
...
DEFAULT_UA = 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36'
...
class GUI(QMainWindow):
    ...
    # Base URL for search
    sURL = 'http://mangafox.me/search.php?'

    # Search method
    # (cw = contain, bw = begin, ew = end)
    sNAME_METHOD = 'name_method=cw'
    ...
    # Author method
    # (cw = contain, bw = begin, ew = end)
    sAUTHOR_METHOD = '&author_method=cw'
    ...
    # Artist method
    # (cw = contain, bw = begin, ew = end)
    sARTIST_METHOD = '&artist_method=cw'
    ...
    sGENRE_ACTION        = '&genres%5BAction%5D=0'
    sGENRE_ADULT         = '&genres%5BAdult%5D=0'
    sGENRE_ADVENTURE     = '&genres%5BAdventure%5D=0'
    sGENRE_COMEDY        = '&genres%5BComedy%5D=0'
    sGENRE_DOUJINSHI     = '&genres%5BDoujinshi%5D=0'
    sGENRE_DRAMA         = '&genres%5BDrama%5D=0'
    sGENRE_ECCHI         = '&genres%5BEcchi%5D=0'
    sGENRE_FANTASY       = '&genres%5BFantasy%5D=0'
    sGENRE_GENDER_BENDER = '&genres%5BGender+Bender%5D=0'
    sGENRE_HAREM         = '&genres%5BHarem%5D=0'
    sGENRE_HISTORICAL    = '&genres%5BHistorical%5D=0'
    sGENRE_HORROR        = '&genres%5BHorror%5D=0'
    sGENRE_JOSEI         = '&genres%5BJosei%5D=0'
    sGENRE_MARTIAL_ARTS   = '&genres%5BMartial+Arts%5D=0'
    sGENRE_MATURE        = '&genres%5BMature%5D=0'
    sGENRE_MECHA         = '&genres%5BMecha%5D=0'
    sGENRE_MYSTERY       = '&genres%5BMystery%5D=0'
    sGENRE_ONE_SHOT      = '&genres%5BOne+Shot%5D=0'
    sGENRE_PSYCHOLOGICAL = '&genres%5BPsychological%5D=0'
    sGENRE_ROMANCE       = '&genres%5BRomance%5D=0'
    sGENRE_SCHOOL_LIFE   = '&genres%5BSchool+Life%5D=0'
    sGENRE_SCI_FI        = '&genres%5BSci-fi%5D=0'
    sGENRE_SEINEN        = '&genres%5BSeinen%5D=0'
    sGENRE_SHOUJO        = '&genres%5BShoujo%5D=0'
    sGENRE_SHOUJO_AI     = '&genres%5BShoujo+Ai%5D=0'
    sGENRE_SHOUNEN       = '&genres%5BShounen%5D=0'
    sGENRE_SHOUNEN_AI    = '&genres%5BShounen+Ai%5D=0'
    sGENRE_SLICE_OF_LIFE = '&genres%5BSlice+of+Life%5D=0'
    sGENRE_SMUT          = '&genres%5BSmut%5D=0'
    sGENRE_SPORTS        = '&genres%5BSports%5D=0'
    sGENRE_SUPERNATURAL  = '&genres%5BSupernatural%5D=0'
    sGENRE_TRAGEDY       = '&genres%5BTragedy%5D=0'
    sGENRE_WEBTOONS      = '&genres%5BWebtoons%5D=0'
    sGENRE_YAOI          = '&genres%5BYaoi%5D=0'
    sGENRE_YURI          = '&genres%5BYuri%5D=0'

    # Release method
    # (eq = On, before = lt, after = gt)
    sRELEASE_METHOD = '&released_method=eq'

    # Relase data (YYYY)
    sRELEASE_DATE = '&released='

    # Rating method
    # (eq = Equal, lt = Less Than, gt = Greater Than)
    sRATING_METHOD = '&rating_method=eq'
    ...
    sRUNNING = '&is_completed='

    # Set advanced search options ON
    sADVANCED_OPTIONS = '&advopts=1i'
    ...
    def initialize(self):
        ...
        # Search action
        searchAction = QAction(QIcon('media/search-icon.png'), '&Search', self)
        ...
        # Exit action
        exitAction = QAction(QIcon('media/exit-icon.png'), '&Exit', self)
        exitAction.setShortcut('Ctrl+X')
        exitAction.setStatusTip('Exit the application')
        exitAction.triggered.connect(qApp.quit)

        # About action
        aboutAction = QAction(QIcon('media/about-icon.png'), '&About', self)
...
if __name__ == '__main__':
    ...
    print('MangaFox Search Scraper')
    print(' (https://fleptic.eu)\n')
